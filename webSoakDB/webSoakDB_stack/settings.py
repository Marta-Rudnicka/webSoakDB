"""
Django settings for webSoakDB_stack project.
...
SECRET_KEY = 'FprflpUfVtgFJc1AU3tzFvHgvbWGVeUD6vf4IxXp6s1aEYHgYd'
...
ROOT_URLCONF = 'webSoakDB_stack.urls'
...
WSGI_APPLICATION = 'webSoakDB_stack.wsgi.application'
