# Generated by Django 3.1.5 on 2021-07-26 17:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auth', models.ManyToManyField(blank=True, related_name='project_obj', to='API.IspybAuthorization')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('library_plate', models.CharField(blank=True, max_length=100, null=True)),
                ('well', models.CharField(blank=True, max_length=4, null=True)),
                ('code', models.CharField(blank=True, max_length=100, null=True)),
                ('smiles', models.CharField(blank=True, max_length=256, null=True)),
                ('crystal', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='compounds', to='API.crystal')),
                ('project', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='API.project')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('compound_combination', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='lab_data', to='API.compoundcombination')),
                ('crystal_name', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='lab_data', to='API.crystal')),
                ('project', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='API.project')),
                ('single_compound', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='lab_data', to='API.spacompound')),
                ...
                ('batch', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='crystals', to='API.batch')),
            ],
        ),
        migrations.CreateModel(
            name='Dimple',
        ...
        migrations.AlterUniqueTogether(
            name='crystal',
            unique_together={('crystal_name', 'project', 'product')},
        ),
        migrations.AddField(
            model_name='batch',
            name='crystal_plate',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='API.crystalplate'),
        ),
    ]
