...
urlpatterns = [
	...
	#path("library_detail/<int:pk>/", views.dummy, name="library_detail"),
	...
	#path("api/summary/<str:name>", views.ProposalSelection.as_view(), name="proposal_summary"),
	path("summary/", views.ProposalSelection.as_view(), name="proposals"),
]
